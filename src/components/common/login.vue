          ...
          <div class="container">
            ...
            <el-form :label-position="labelPosition" label-width="80px" :model="formLabelAlign">
              ...
              <div class="options">
                ...
                <div class="register">
                  <span>没有账号?</span>
                  <span><a href="javascript:;" @click="go2reg()">去注册</a></span>
                </div>
              </div>
            </el-form>
          </div>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      this.loginForm.username = this.formLabelAlign.username
      this.loginForm.password = sha256(this.formLabelAlign.password)
